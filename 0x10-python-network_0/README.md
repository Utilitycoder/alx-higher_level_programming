...
In this networking project, I learned about `curl` and used it in Bash scripts to send various types
of HTTP headers. In the process, I learned about how URL, domain names,
...
* **5. cURL POST parameters**
  * [5-post_params.sh](./5-post_params.sh): Bash script that sends a `POST`
  request to a given URL with the variables `test@gmail.com` and
