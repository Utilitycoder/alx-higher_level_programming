...
and `POST` requests, fetching JSON resources, and interacted with several API's (the
Star Wars API, GitHub API, and Twitter API). This is quite one of the days I really love working with python. I don't like snakes!
