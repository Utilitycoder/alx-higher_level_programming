...
During the project, I gained knowledge about the use of Object-Relational Mapping (ORM) in database scripting. I gained proficiency in using MySQLdb and SQLAlchemy to perform tasks like querying, creating, editing, and deleting tables in MySQL.
